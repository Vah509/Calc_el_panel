...
class TableConfig:
    ...
    edit_mode: Literal["modal", "own_page"] = "modal"
                                    ...
                                    #     страницу-карточку вне движка (например kit
                                    #     с вложенным kit_items) — движок для этой
                                    #     таблицы отдаёт только список, не модалку.
