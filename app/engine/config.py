...
class TableConfig:
    ...
    materials_recalc_action: Optional[str] = None
                                    ...
                                    # "Пересчитать" на вкладке материалов, обновляющая
                                    # price_excl_vat всех позиций из справочника
                                    # material.price_excl_vat (см. HANDOFF: "заходим в
                                    # таблицу материалов и смотрим текущую цену").
